# You don't need to create the Room class yourself; it's already provided in the spookymanor library.
...
# This block of code connects all of the rooms together. Take a look at the map in the instructions to see how they are connected.
